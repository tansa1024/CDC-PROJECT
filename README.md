...
3.  Fusion Layer: Concatenates both streams into feature vector for final price regression.

Setup & Installation
1. Environment Requirements
* virtual environment with kernel python 3.12.5 (Done in VS CODE)
* Install necesssary libraries as shown in the jupyter notebook
* There is different version of pytorch for GPU support install the necessary library

How To RUN 
Preprocessing: Ensure house prices are log-transformed ($log(1+x)$) to stabilize training.
...
Grad-CAM: Use the generate_final_gradcam function to visualize what the model is "looking at".
